...
class Enrollment:
    ...
    def __init__(self, enrollment_id:str, course_code:str, student_name:str,
                 grade_level:str, duration_days:int, start_date:date, registration_date:date, course_name:str):
    ...
    def calculate_fee(self):
        ...
        # Business Rules:
        # Step 1 — base_fee by duration_days:
        #   duration_days <= 30  -> base_fee = duration_days * 500.0
        #   duration_days <= 60  -> base_fee = duration_days * 800.0
        #   duration_days > 60   -> base_fee = duration_days * 1200.0
        #
        # Step 2 — scholarship_amount by grade_level:
        #   Level01 or Level02   -> scholarship = base_fee * 0.20
        #   Level03 or Level04   -> scholarship = base_fee * 0.10
        #   Level05 or Level06   -> scholarship = base_fee * 0.05
        #
        # payable_fee = base_fee - scholarship_amount
        # Set all three fields. Return scholarship_amount.
        pass
