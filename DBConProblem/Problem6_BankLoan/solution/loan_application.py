...
class LoanApplication:
    ...
    def __init__(self, loan_id: str, applicant_id: str, date_of_application: date,
                 loan_type: str, date_of_disbursement: date, loan_amount: float,
                 tenure_in_months: int, credit_score: int, loan_status: str):
