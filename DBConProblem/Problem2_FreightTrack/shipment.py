...
class Shipment:
    ...
    def calculate_base_charge(self):
        ...
        # Business Rule:
        # base_charge = weight_kg * no_of_days * 10.0
        # Apply weight surcharge:
        #   weight_kg > 200  -> surcharge = base_charge * 0.15
        #   weight_kg > 100  -> surcharge = base_charge * 0.08
        #   otherwise        -> surcharge = 0.0
        # total_charge = base_charge + surcharge
        # Set base_charge, surcharge, total_charge.
