...
class EmpReimbursement:
    ...
    def __init__(self,request_id :str, employee_code:str,date_of_request :date,grade:str,date_of_travel :date,no_of_days_of_stay :int,local_travel_in_kms :float,manager_approval:str):
