...
class Shipment:
    ...
    def __init__(self,shipment_id:str,freight_id:str,client_name:str,weight_kg:float,no_of_days:int,dispatch_date:date,service_type:str,status:str,booking_date:date):
    ...
    def calculate_all_charge(self):
        self.__base_charge=self.__weight_kg*self.__no_of_days*10.0
        
        if self.__weight_kg>200:
            self.__surcharge=self.__base_charge*0.15
        elif self.__weight_kg>100:
            self.__surcharge=self.__base_charge*0.08
        
        self.__total_charge=self.__base_charge+self.__surcharge
